...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>Friezzie</title>
        <meta name="description" content="ICO-Dapp" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Friezzie ICO!</h1>
          <div className={styles.description}>
            You can claim or mint Friezzie tokens here
          </div>
          {walletConnected ? (
            <div>
              <div className={styles.description}>
      ...
      <footer className={styles.footer}>Made with &#10084; by Friezzie</footer>
    </div>
  );
}
